...
### Key Features
* **Semantic URLs**: Chapter files have been renamed from numeric IDs to descriptive semantic paths (e.g. `ch9-definitions.xhtml`).
* **Responsive Layout**: The UI handles sticky navigation menus across viewport sizes without occluding content.
* **Lenient HTML Parsing**: The application gracefully handles imperfectly closed XHTML tags generated by LLMs via fallback HTML parsing, avoiding strict XML browser errors.
